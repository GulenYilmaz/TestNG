 ...
 * What is TestNG: TestNG is a testing tool, it is a unit test framework designed for testing needs,
	 ...
	 * Why to Use TestNG: major advantages of TestNG are :
		â—? It gives the ability to produce HTML Reports of execution
		â—? Annotations made testers life easy
		â—? Test cases can be Grouped & Prioritized (You can Set the Execution Order) more easily
		â—? Parallel testing is possible
		â—? Batch execution is possible
		â—? Assertions (verifications) is possible
		â—? Data Parameterization is possible
		â—? TestNG can be easily integrated with many different tools: selenium, maven, cucumber etc
